...
tellraw @s [{"score":{"objective":"variables","name":"#a"},"color":"gold"},{"text":" + ","color":"gold"},{"score":{"objective":"variables","name":"#b"},"color":"gold"},{"text":"X = ","color":"gold"},{"score":{"objective":"variables","name":"#c"},"color":"gold"},{"text":" + ","color":"gold"},{"score":{"objective":"variables","name":"#z"},"color":"gold"},{"text":"X","color":"gold"}]
...
tellraw @s {"translate":"dsb.events.library_task.wait_round","color":"gold"}