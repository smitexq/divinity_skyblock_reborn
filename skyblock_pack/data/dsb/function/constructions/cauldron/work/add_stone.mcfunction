setblock 17112022 0 0 minecraft:shulker_box{Items:[{Slot:0b, id:"minecraft:cobblestone", count:1}]}
setblock 17112022 1 0 minecraft:light_blue_shulker_box

###Вставляем кол-во булыжника из хранилища. Если его там 0, то заменяем на воздух
$data modify block 17112022 0 0 Items[0].count set from storage dsb:cts Cauldron.$(out).itemCount
$execute if data storage dsb:cts Cauldron.$(out){itemCount:0} run item replace block 17112022 0 0 container.0 with minecraft:air
...
$data modify storage dsb:cts Cauldron.$(out).itemCount set from block 17112022 0 0 Items[0].count
