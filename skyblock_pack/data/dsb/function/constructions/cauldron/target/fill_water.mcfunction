#Если в котле лава
$execute if items entity @s weapon.mainhand minecraft:bucket at $(out) if block ~ ~ ~ minecraft:lava_cauldron run return run function dsb:constructions/cauldron/target/get_lava
