...
$data modify entity @s item set value {count: $(count), id: "minecraft:structure_block", components:{"minecraft:item_model": "dsb:soul", "minecraft:enchantment_glint_override": true}}
