...
$execute unless score *var1 variables >= *var2 variables run summon item ~ ~ ~ {Item:{id:"minecraft:netherrack", count:$(level)}}
...
execute if score *var1 variables >= *var2 variables run data modify entity @s Item.id set value "minecraft:netherrack"
