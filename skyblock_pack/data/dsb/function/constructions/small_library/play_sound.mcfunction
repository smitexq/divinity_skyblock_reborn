			...
			#===============#
			#
execute if entity @s[tag=!initS.library] run return 0
...
function dc:get_call {tick:100, command:"function dsb:constructions/small_library/play_sound", requirePos:false, requireEntity:true}