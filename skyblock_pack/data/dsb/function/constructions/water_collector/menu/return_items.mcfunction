...
#Копируем предметы в шалкер, очищая интерактивный слот, чтобы вернуть предметы, которые положили вместо стекла
...
execute at @s run loot spawn ~ ~1.2 ~ mine 17112022 0 0 minecraft:stick[minecraft:custom_data={drop_contents:true}]
