...
$execute if data storage dsb:cts BlazeSpawner.$(out){itemCount:0} run item replace block 17112022 0 0 container.0 with minecraft:air
...
$data modify storage dsb:cts BlazeSpawner.$(out).itemCount set from block 17112022 0 0 Items[0].count
