...
execute positioned ^0.75 ^1.3 ^ run summon arrow ~ ~ ~ {NoGravity:1b,Tags:["this","hexagon","3"], damage:3.5}
...
function dc:get_call {tick:10, command:"function entities:mobs/abilities/hexagon_of_arrows/frames/3", requirePos:false, requireEntity:true}