...
execute positioned ^-0.75 ^-1.3 ^ run summon arrow ~ ~ ~ {NoGravity:1b,Tags:["this","hexagon","6"], damage:3.5}
...
function dc:get_call {tick:10, command:"function entities:mobs/abilities/hexagon_of_arrows/select_motion", requirePos:false, requireEntity:true}
