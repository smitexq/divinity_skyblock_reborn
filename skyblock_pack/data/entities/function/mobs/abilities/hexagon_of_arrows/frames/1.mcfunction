...
execute positioned ^1.5 ^ ^ run summon arrow ~ ~ ~ {NoGravity:1b,Tags:["this","hexagon","2"], damage:3.5}
...
function dc:get_call {tick:10, command:"function entities:mobs/abilities/hexagon_of_arrows/frames/2", requirePos:false, requireEntity:true}