...
#Имя и звуки
data modify entity @s CustomName set value '{"text":"✇","color":"aqua","extra":[{"text":"✇✇","color":"white"}]}'
playsound minecraft:block.note_block.iron_xylophone ambient @a[distance=..10] ~ ~ ~ 2 0.5
...
function dc:get_call {tick:20, command:"function entities:mobs/abilities/charged_ray/sound_step2", requirePos:false, requireEntity:true}