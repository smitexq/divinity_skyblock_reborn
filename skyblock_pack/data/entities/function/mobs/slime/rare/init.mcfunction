...
data modify entity @s[type=minecraft:slime] CustomName set value '{"translate":"dsb.entity.boss.rare","color":"gold","with":[{"translate":"entity.minecraft.slime"}]}'
data modify entity @s[type=minecraft:magma_cube] CustomName set value '{"translate":"dsb.entity.boss.rare","color":"gold","with":[{"translate":"entity.minecraft.magma_cube"}]}'
