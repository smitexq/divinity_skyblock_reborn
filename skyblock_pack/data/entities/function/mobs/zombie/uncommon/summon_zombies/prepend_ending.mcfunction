...
$function dc:get_call {tick:12, command:"function entities:mobs/zombie/uncommon/summon_zombies/summon_is_ending {out:$(out)}", requirePos:false, requireEntity:true}