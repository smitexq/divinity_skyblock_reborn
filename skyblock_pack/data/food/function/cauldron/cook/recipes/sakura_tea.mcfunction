...
data modify storage dsb:recipes TitleText.text1 set value "dsb.items.food.sakura_tea"
...
#Листва
execute store result storage dsb:recipes TitleText.count int 1 store result score *var1 variables run data get storage dsb:recipes Tea.Items[{id:"minecraft:cherry_leaves"}].count

scoreboard players set *var2 variables 10
execute store result storage dsb:recipes TitleText.count int 1 run scoreboard players operation *var2 variables -= *var1 variables
data modify storage dsb:recipes TitleText.text2 set value "block.minecraft.cherry_leaves"
execute if score *var1 variables matches ..9 run return run function food:cauldron/cook/recipes/title with storage dsb:recipes TitleText
...
execute if score *var1 variables matches ..2 run return run function food:cauldron/cook/recipes/title with storage dsb:recipes TitleText
