...
data modify storage dsb:recipes TitleText.text1 set value "dsb.items.food.green_tea"
...
scoreboard players set *var2 variables 8
execute store result storage dsb:recipes TitleText.count int 1 run scoreboard players operation *var2 variables -= *var1 variables
data modify storage dsb:recipes TitleText.text2 set value "dsb.items.food.tea_leaves"
execute if score *var1 variables matches ..7 run return run function food:cauldron/cook/recipes/title with storage dsb:recipes TitleText
